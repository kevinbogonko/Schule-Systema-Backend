...
import { StudentMarkAnalysis } from "../../../controllers/exams/ruExamController.js";
import { generateMarkAnalysisPDF } from "../../../controllers/reports/analysis/markanalysis.js";
...
router.post("/markanalysis", async (req, res, next) => {
  try {
    ...
    console.log(marklistData.examDetails);
    // res.json(marklistData);
